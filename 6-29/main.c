...
static void devone_timeout(struct timer_list *t)
{
    // struct devone_data *dev = (struct devone_data *)arg;
    struct devone_data *dev = from_timer(dev, t, timeout);
    unsigned long flags;
...
int devone_open(struct inode *inode, struct file *filp)
{
    ...
    // https://satoru-takeuchi.hatenablog.com/entry/2020/03/26/011805
