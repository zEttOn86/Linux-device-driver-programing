/**
 * static registration major number with legacy interface
 * 
 * */
...
static int devone_init(void)
{
    ...
    int ret = 0;
    // 1st arg == 0
    // if succeed, major number will be returned, else minus number will be returned
    // 1st arg > 0
    // if succeed, 0 will be returned, else minus number will be returned
